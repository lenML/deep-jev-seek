    ...
    <Card className={cn("overflow-hidden", className)}>
      ...
      <CardContent className="p-0">
        <Textarea
          ...
          spellCheck={false}
          className="editor-scroll min-h-[23rem] resize-y rounded-none border-0 bg-[#060c09] px-4 py-4 font-mono text-[12px] leading-5 text-[#dce8df] shadow-none focus:border-0 focus:ring-2 focus:ring-inset focus:ring-accent/75 sm:px-5"
        />
        {error ? (
