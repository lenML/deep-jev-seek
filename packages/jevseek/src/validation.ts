...
export function validateQuestion(
  ...
  switch (question.type) {
    ...
    default:
      throw new JevSeekValidationError(`${label}.type must be "choice", "score", or "noul"`);
  }
}

export function validateQuestions(questions: unknown): asserts questions is QuestionSet {
